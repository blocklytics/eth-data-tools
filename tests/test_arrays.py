...
class TestArraysEventLogs:
    """Test cases:
        ...
        5. Decoding a custom ABI and an event log for dynamic - data passed in event data
        6. Decoding a custom ABI and an event log for dynamic arrays - data passed in event topics
        7. Decoding a custom ABI and an event log for 2D arrays - data passed in event topics
    """
...
class TestTwoDimensionalArrays:
    """Test cases:
            ...
            6. Decoding a cusotom ABI and transaction for static-dynamic type
